...
public class MethodCallHandlerImplTest {
  ...
  public void onMethodCall_setsIgnoredPackages() {
    ...
    assertEquals(Intent.ACTION_MAIN, actualActivity.getAction());
    assertNotEquals(ignoredPackage, actualActivity.getPackage());
  }

  @Test
  public void onMethodCall_launchChooserWithTitle() {
    sender.setApplicationContext(context);
    Map<String, Object> args = new HashMap<>();
    ...
    methodCallHandler.onMethodCall(new MethodCall("launchChooser", args), result);
  ...
  @Test
  public void onMethodCall_launchChooserWithIgnoredPackages() {
    sender.setApplicationContext(context);
    Map<String, Object> args = new HashMap<>();
    args.put("action", Intent.ACTION_MAIN);
    Result result = mock(Result.class);
