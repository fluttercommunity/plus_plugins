...
public class Extras {
  public static android.os.Bundle convert(String arguments) {
    RuntimeTypeAdapterFactory<PutBase> putBaseRuntimeTypeAdapterFactory = RuntimeTypeAdapterFactory
        ...
        .registerSubtype(PutBundleParcelableArray.class, "PutBundleParcelableArray")
        .registerSubtype(PutBundleParcelableArrayList.class, "PutBundleParcelableArrayList")
