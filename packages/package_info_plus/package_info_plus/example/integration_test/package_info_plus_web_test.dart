...
void main() {
  ...
  group('Package Info Web', () {
    ...
    testWidgets('Get correct values when using a custom base URL', (
      tester,
    ) async {
    ...
    testWidgets('Get correct versionJsonUrl for http and https', (
      tester,
    ) async {
      expect(
      ...
      expect(
        plugin.versionJsonUrl(
          'https://example.com/?hello_world=true#/my-page',
          1,
        ),
        Uri.parse('https://example.com/version.json?cachebuster=1'),
      );
    ...
    testWidgets('Get correct versionJsonUrl for urls to html files', (
      tester,
    ) async {
      expect(
      ...
      expect(
        plugin.versionJsonUrl(
          'https://example.com/index.html?hello_world=true/#/my-page',
          1,
        ),
        Uri.parse('https://example.com/version.json?cachebuster=1'),
      );
      ...
      expect(
        plugin.versionJsonUrl(
          'https://example.com/a/b/c/my-special-file.html',
          1,
        ),
        Uri.parse('https://example.com/a/b/c/version.json?cachebuster=1'),
      );
