...
G_DEFINE_TYPE(DataStrengthPlusPlugin, data_strength_plus_plugin, g_object_get_type())

// Called when a method call is received from Flutter.
static void data_strength_plus_plugin_handle_method_call(
    DataStrengthPlusPlugin* self,
...
static void data_strength_plus_plugin_class_init(DataStrengthPlusPluginClass* klass) {
...
void data_strength_plus_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
