...
/**
 * Handles the callback based status information about a successful or dismissed share. Used to link
 * multiple different callbacks together for easier use.
 */
internal class ShareSuccessManager(private val context: Context) : ActivityResultListener {
  ...
  /**
   * Set result callback that will wait for the share-sheet to close and get either the
   * componentname of the chosen option or an empty string on dismissal.
   */
  ...
  /** Handler called after a share sheet was closed. Called regardless of success or dismissal. */
  ...
  /**
   * Companion object holds constants used throughout the plugin when attempting to return the share
   * result.
   */
  companion object {
    /**
     * When the application's activity is [androidx.fragment.app.FragmentActivity], requestCode can
