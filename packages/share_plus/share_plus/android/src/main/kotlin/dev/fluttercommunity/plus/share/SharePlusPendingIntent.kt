...
/**
 * This helper class allows us to use FLAG_MUTABLE on the PendingIntent used in the Share class, as
 * it allows us to make the underlying Intent explicit, therefore avoiding any risks an implicit
 * mutable Intent may carry.
 *
 * When the PendingIntent is sent, the system will instantiate this class and call `onReceive` on
 * it.
 */
