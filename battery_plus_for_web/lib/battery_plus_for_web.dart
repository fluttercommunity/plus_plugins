...
class BatteryPlusPlugin extends BatteryPlusPlatform {
  ...
  /// Factory method that initializes the BatteryPlus plugin platform with an instance
  /// of the plugin for the web.
  static void registerWith(Registrar registrar) {
    BatteryPlusPlatform.instance = BatteryPlusPlugin(html.window.navigator);
  }
