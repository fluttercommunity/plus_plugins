...
import 'package:connectivity_plus_for_web/connectivity_for_web.dart';
...
class NetworkInformationApiConnectivityPlugin extends ConnectivityPlugin {
  ...
  NetworkInformationApiConnectivityPlugin() : this.withConnection(html.window.navigator.connection);

  /// Creates the plugin, with an override of the NetworkInformation object.
  @visibleForTesting
  NetworkInformationApiConnectivityPlugin.withConnection(html.NetworkInformation connection)
  ...
  Stream<ConnectivityResult> get onConnectivityChanged {
    if (_connectivityResultStreamController == null) {
      _connectivityResultStreamController = StreamController<ConnectivityResult>();
      ...
      _connectivityResultStream = _connectivityResultStreamController.stream.asBroadcastStream();
    }
